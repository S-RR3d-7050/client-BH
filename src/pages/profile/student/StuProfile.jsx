        ...
        <div className={styles.profileCont}>
            ...
            <div className={styles.formCont}>
                ...
                <form className={styles.form}>
                    ...
                    <input type='text' className={styles.inp} name='CIN' value={data.CIN} onChange={handleChange} placeholder={t('CIN')} />

                    <label htmlFor='phone'>{`${t('Phone')}:`}</label>
                    <input type='text' className={styles.inp} name='phone' value={data.phone} onChange={handleChange} placeholder={t('Phone')}/>

                    <label htmlFor='address'>{`${t('Address')}:`}</label>
                    <input type='text' className={styles.inp} name='phone' value={data.address} onChange={handleChange} placeholder={t('Address')}/>
        ...
        <section className={styles.main}>
            <div className={styles.flex}>
                ...
                <div className={styles.btnDiv}>
                    <button style={{background: '#103561', color: '#fff'}}>{t("confirmation.done")}
